  ...
  return (
    <div className='content'>
      <div className='container-search'>
        <p className='title-welcome'>Welcome <span className='welcome-text'>{trainer}</span>, here you can find your favorite pokemon </p>

        <div className='search-content'>
          
          <form onSubmit={handleSubmit}>
            <input className='input-search' ref={inputSearch} type="text" placeholder='Nombre'/>
            <Boton texto={'Search'} />
          </form>

          <SelectType
            setTypeSelected={setTypeSelect}
          />
